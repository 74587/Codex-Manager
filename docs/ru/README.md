<table align="center">
  <tr>
    <td align="center" valign="middle" width="44%">
      <img src="../../assets/logo/readme-header-ru.png" alt="CodexManager — локальный менеджер пула аккаунтов Codex" width="460" />
      <br />
      <sub>
    ...
    <td align="center" valign="middle" width="20%">
      ...
      <a href="https://xuanwu.openatom.org/articles/project/codex-manager/" title="Сообщество Xuanwu">
        <img src="https://xuanwu.openatom.org/logo.png" alt="Сообщество Xuanwu" height="30" />
      </a>
    </td>
  </tr>
</table>
...
[![PatewayAI — официальный высококачественный API relay для моделей](../../assets/images/sponsors/patewayai-banner-en-4k.png)](https://pateway.ai/?ch=kimnmd)
...
<table>
  <tr>
    ...
    <td valign="top">
      <strong><a href="https://vmcardio.com/zh/register?code=OPK6X2DSLW">Корпоративная платформа виртуальных карт VMCard</a></strong> предлагает выделенные американские Visa BIN, массовый выпуск карт через API и корпоративное управление платежами для AI-платформ, поставщиков AI API и команд с большим числом подписок.<br />
      Выгодный расчётный курс для долгосрочных корпоративных платежей. Сотрудничество: <a href="https://t.me/Vmcardio_yuki">@Vmcardio_yuki</a>
    </td>
  </tr>
  <tr>
    <td align="center" valign="middle" width="180">
    ...
    <td valign="top">
      <strong><a href="https://88api.ai/sign-up?aff=OceE">88API — платформа агрегации моделей</a></strong><br />
      🧠 Языковые и программные модели GPT, Claude, Gemini, Grok, DeepSeek, Kimi, GLM и другие;<br />
      🎨 Модели изображений GPT-Image, Gemini, Grok и другие;<br />
      🎬 Видеомодели Seedance, Veo, MiniMax Hailuo H3, Kling, Grok и другие;<br />
      🎙️ Whisper, TTS и другие голосовые возможности — от текста и изображений до видео и озвучивания.<br />
      🎁 Новые пользователи получают пробный баланс; на сайте работает служба поддержки.<br />
      👉 Зарегистрированная зарубежная компания, официальные счета и пополнение 1:1.
    </td>
  </tr>
  <tr>
    <td align="center" valign="middle" width="180">
    ...
    <td valign="top">
      <strong><a href="https://api.fenno.ai/s/4ADZ">FennoAI</a></strong> предоставляет стабильный высокопроизводительный API relay для корпоративных R&amp;D-команд и разработчиков, совместимый с протоколами OpenAI и Anthropic и инструментами Codex, Claude Code и OpenCode. Инфраструктура рассчитана на сотни миллиардов токенов в день и поддерживает корпоративные расчёты и счета. По <a href="https://api.fenno.ai/s/4ADZ">специальной ссылке</a> пользователи Codex-Manager получают Coding Plan на 50 долларов за 1,99 доллара; реферальная комиссия — до 20%.
    </td>
  </tr>
  <tr>
    <td align="center" valign="middle" width="180">
    ...
    <td valign="top">
      <strong><a href="https://s.qiniu.com/eiaQrq">Qiniu Cloud AI</a></strong> — корпоративная MaaS-платформа Qiniu Cloud (02567.HK) с единым доступом к более чем 150 мировым моделям для текста, изображений, аудио, видео и файлов. По <a href="https://s.qiniu.com/eiaQrq">специальной ссылке</a> корпоративные пользователи Codex-Manager бесплатно получают 12 млн токенов, разработчики — 3 млн.
    </td>
  </tr>
  <tr>
    <td align="center" valign="middle" width="180">
    ...
    <td valign="top">
      <strong><a href="https://www.aixiamo.com/?utm_source=github&utm_medium=sponsor&utm_campaign=codex_manager&utm_content=brand_home_v3">AIXiamo — официальное пополнение ChatGPT Plus / Pro для собственного аккаунта в Китае</a></strong><br />
      ...
      <strong>Руководство спонсора:</strong> <a rel="sponsored nofollow" href="https://github.com/momochoog/gpt-daichong">выбор и пополнение ChatGPT Plus / Pro в Китае в 2026 году</a><br />
      Поддерживается Alipay без зарубежной карты; сервис не запрашивает пароли, коды подтверждения или восстановления. Заказы отслеживаются, доступна поддержка на китайском, неудачные пополнения возвращаются после проверки. Также доступны Claude Pro / Max, Gemini, Grok / SuperGrok и другие подписки.<br />
...
<table>
  ...
  <tr>
    <td align="center"><img src="../../assets/images/AliPay.jpg" alt="QR-код Alipay для поддержки" width="220" /></td>
    <td align="center"><img src="../../assets/images/wechatPay.jpg" alt="QR-код WeChat Pay для поддержки" width="220" /></td>
  </tr>
</table>
...
<a href="https://www.star-history.com/?repos=qxcnm%2FCodex-Manager&type=date&legend=top-left">
 <picture>
   ...
   <img alt="График истории звёзд Codex Manager" src="../../assets/images/star-history-light.png" />
 </picture>
</a>
